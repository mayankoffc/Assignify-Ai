        ...
        <svg width="350" height="220" viewBox="0 0 350 220" className="overflow-visible">
          {type === 'Q1_GRAPH' && (
            <>
              ...
              <PencilArrow x1={40} y1={180} x2={40} y2={20} seed={seed + 1} />
              <PencilText x={280} y={195} text="Strain" seed={seed + 2} />
              <PencilText x={10} y={15} text="Stress" seed={seed + 3} />
              <g className="graphite-pencil">
                <path d={`M40,180 Q${100+randomRange(seed, -5,5)},${80+randomRange(seed, -5,5)} 180,60 T280,100`} stroke="#2d2d2d" strokeWidth="1.8" fill="none" strokeLinecap="round" />
                 <path d={`M40,180 Q${100+randomRange(seed, -5,5)},${80+randomRange(seed, -5,5)} 180,60`} stroke="#2d2d2d" strokeWidth="1.2" fill="none" strokeLinecap="round" opacity="0.4" />
              </g>
              <WobbleLine x1={180} y1={60} x2={180} y2={180} seed={seed+4} strokeWidth={0.8} />
              <PencilText x={205} y={40} text="Elastic Limit" seed={seed+6} fontSize={12} />
            </>
          )}
          {type === 'Q3_WAVE' && (
             <>
               <PencilArrow x1={20} y1={100} x2={320} y2={100} seed={seed} />
               <PencilArrow x1={20} y1={180} x2={20} y2={20} seed={seed+1} />
               <path d="M20,100 Q60,40 100,100 T180,100 T260,100" stroke="#2d2d2d" strokeWidth="1.5" fill="none" className="graphite-pencil" />
               <PencilText x={150} y={190} text="AM Wave" seed={seed+9} />
             </>
          )}
          {type === 'Q4_SPRING' && (
             <>
                <WobbleLine x1={20} y1={150} x2={330} y2={150} seed={seed} /> 
                <WobbleLine x1={60} y1={110} x2={110} y2={110} seed={seed+1} />
                <WobbleLine x1={60} y1={150} x2={110} y2={150} seed={seed+2} />
                <WobbleLine x1={60} y1={110} x2={60} y2={150} seed={seed+3} />
                <WobbleLine x1={110} y1={110} x2={110} y2={150} seed={seed+4} />
                <PencilText x={75} y={135} text="m1" seed={seed+5} />
                <path d="M110,130 L240,130" stroke="#2d2d2d" strokeWidth="1" strokeDasharray="5,3" fill="none" className="graphite-pencil" />
                <path d="M110,130 L125,115 L140,145 L155,115 L170,145 L185,115 L200,145 L215,115 L225,145 L240,130" stroke="#2d2d2d" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round" className="graphite-pencil" />
                <WobbleLine x1={240} y1={110} x2={290} y2={110} seed={seed+6} />
                <WobbleLine x1={240} y1={150} x2={290} y2={150} seed={seed+7} />
                <WobbleLine x1={240} y1={110} x2={240} y2={150} seed={seed+8} />
                <WobbleLine x1={290} y1={110} x2={290} y2={150} seed={seed+9} />
                <PencilText x={255} y={135} text="m2" seed={seed+10} />
             </>
          )}
          {type === 'Q5_LENS' && (
             <>
               <WobbleLine x1={20} y1={110} x2={330} y2={110} seed={seed} />
               <path d={`M175,50 Q${195+randomRange(seed, -2,2)},110 175,170`} stroke="#2d2d2d" strokeWidth="1.2" fill="none" className="graphite-pencil" />
               <path d={`M175,50 Q${155+randomRange(seed, -2,2)},110 175,170`} stroke="#2d2d2d" strokeWidth="1.2" fill="none" className="graphite-pencil" />
               <WobbleLine x1={80} y1={110} x2={80} y2={60} seed={seed+1} strokeWidth={1.5} />
               <PencilText x={75} y={130} text="u" seed={seed+4} fontSize={12} />
               <WobbleLine x1={80} y1={60} x2={175} y2={60} seed={seed+5} strokeWidth={0.8} /> 
               <WobbleLine x1={175} y1={60} x2={270} y2={140} seed={seed+6} strokeWidth={0.8} /> 
             </>
          )}
        </svg>
      </div>
...
const ProcessingScreen: React.FC<{ file: UploadedFile | null, onComplete: (solutions: QuestionSolution[]) => void }> = ({ file, onComplete }) => {
  ...
  useEffect(() => {
    ...
    const processFile = async () => {
        setLogLines(prev => [...prev, `> FILE RECEIVED: ${file.name}`, "> ESTABLISHING LINK TO GEMINI 2.5 FLASH..."]);
